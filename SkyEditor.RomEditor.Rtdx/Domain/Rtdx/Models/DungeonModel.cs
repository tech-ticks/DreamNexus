...
namespace SkyEditor.RomEditor.Domain.Rtdx.Models
{
    ...
    {
        public DungeonModel(ICommonStrings commonStrings, DungeonDataInfo.Entry data, ItemArrange.Entry itemArrange)
        {
            this.commonStrings = commonStrings ?? throw new ArgumentNullException(nameof(commonStrings));
            this.Data = data ?? throw new ArgumentNullException(nameof(data));
            this.ItemArrange = itemArrange ?? throw new ArgumentNullException(nameof(itemArrange));
        }
